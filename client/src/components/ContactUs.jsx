  ...
  return (
    ...
    >
      <Container maxWidth="md">
        ...
        >
          {/* Left Side: Image with a subtle float effect */}
          <Box sx={{ flex: 1,  }}>
            <Image 
              src={contact} 
            />
          ...
          <Stack spacing={4} sx={{ flex: 1 }}>
            <Box>
              ...
              <Typography variant="h2" fontWeight={800} color="text.primary" sx={{ mb: 1 }}>
                Contact Us
              </Typography>
              <Divider sx={{ width: "60px", borderBottomWidth: 4, borderRadius: 2, borderColor: "primary.main" }} />
            </Box>
